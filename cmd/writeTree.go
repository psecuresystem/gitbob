...
var writeTreeCmd = &cobra.Command{
	Use:   "write-tree",
	Short: "A Command that writes the working directory",
	Long: `A command that scans the working directory and takes all the folders and converts it into a tree`,
	Run: func(cmd *cobra.Command, args []string) {
		fileName := helpers.TransverseTree(".")
